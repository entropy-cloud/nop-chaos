import { shallowRef, toRaw, ref, defineComponent, onMounted, onUnmounted, openBlock, createElementBlock, watchEffect, onBeforeUnmount, reactive, getCurrentInstance, h, Fragment as Fragment$1, Teleport, createApp, Comment, Text, readonly, getCurrentScope, onScopeDispose, unref, createElementVNode, warn as warn$1, watch, inject, computed, isRef, mergeProps, renderSlot, provide, nextTick, useSlots, createBlock, resolveDynamicComponent, withCtx, normalizeClass, createCommentVNode, toRef, createVNode, normalizeStyle, toDisplayString, Transition, withDirectives, createSlots, vShow, createTextVNode, normalizeProps, guardReactiveProps, resolveComponent } from "vue";
...
import { toast, alert as alert$1, confirm, clearStoresCache, setDefaultLocale, render, ToastComponent, ScopedContext, Renderer, FormItem } from "amis";
...
var _excluded$1 = ["component", "node"], _excluded2$1 = ["component", "$slots", "children", "class", "style"], _excluded3$1 = ["className", "classname"], optionsName = "veaury-options", random = new _default$1();
