import { CSSProperties, memo, useCallback, useRef, useState, useEffect} from "react"
...
export const FlowEditorCanvas = memo((props: FlowBuilderProps) => {

  const [diagram] = useState<IFlowJson>(props.graphDiagram || undefined);
  ...
  useEffect(() => {
      if (diagram == null || diagram === undefined) 
        return
      debugger
      const flowJson: IFlowJson = diagram;
